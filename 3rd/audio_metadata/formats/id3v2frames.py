	...
	def _parse_frame_data(data):
		...
		return (
			ID3v2PrivateInfo(
				...
				owner=frame_data[0:owner_end].decode('gbk'),
...
class ID3v2OWNEFrame(ID3v2Frame):
	...
	def _parse_frame_data(data):
		...
		date_of_purchase = remainder[:8].decode('gbk')
		...
		return (
			ID3v2OwnershipTransaction(
				...
				price_paid=price_paid.decode('gbk'),
